 ...
 * Generated at: 2018-05-11 08:40:31 UTC
...
public final class outFeeCancelList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\treport.ParameterByName(\"cashCost\").AsString = r.cashCost;// 现金金额\r\n");
      out.write("\t\treport.ParameterByName(\"isManyWays\").AsString = \" \";\r\n");
      ...
      out.write("\t\ttotCostNumber.setValue(0);\r\n");
      out.write("\t\tdocument.getElementById(\"totCost\").innerHTML = '0';\r\n");
      ...
      out.write("\t\tvar data = {dailySerialId : e, dayNum : 30} ;\r\n");
      ...
      out.write("\t\tvar data = {patientId : e, dayNum : 30} ;\r\n");
      out.write("\t\t$.post(url, data , function(r) {\r\n");
      out.write("\t\t\tshowData(r);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\tvar data = {patientName : e, dayNum : 30} ;\r\n");
      out.write("\t\t$.post(url, data , function(r) {\r\n");
      out.write("\t\t\tshowData(r);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\tvar data = {receiptId : id, dayNum : 30};\r\n");
      out.write("\t\t\t$.post(url, data , function(r) {\r\n");
      out.write("\t\t\t\tshowData(r);\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\tvar data = {receiptNo : no, dayNum : 30};\r\n");
      out.write("\t\t\t$.post(url, data , function(r) {\r\n");
      out.write("\t\t\t\tshowData(r);\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t/* win1.hide();\r\n");
      out.write("\t\tif(r == \"noRec\") {\r\n");
      out.write("\t\t\tmini.alert(\"最近30天没有找到有效的发票\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(r == \"noReg\") {\r\n");
      out.write("\t\t\tmini.alert(\"没有找到挂号记录\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(r == \"noPatient\") {\r\n");
      ...
      out.write("\t\t\tdocument.getElementById(\"outpayRate\").innerHTML = \"自付比例：0.0%\";\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\tdocument.getElementById(\"outpayRate\").innerHTML = \"自付比例：\" + ((r.tag.outpayRate) * 100) + \".0%\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar data = {\r\n");
      ...
      out.write("\t\t\t\t\t\"　总金额：\" + r.tag.totCost + \"　个人自付：\" + r.tag.ownCost + \"　记账：\" + r.tag.pubCost;\r\n");
      ...
      out.write("\t\t\t};\r\n");
      out.write("\t\tgrid1.load(data);\r\n");
      out.write("\t\t//document.getElementById(\"textBref\").innerHTML = e.row.receiptBref;\r\n");
      out.write("\t\t// 回填患者信息\r\n");
      out.write("\t\tvar data2 = {\r\n");
      out.write("\t\t\t\tregisterId : e.row.registerId ,\r\n");
      out.write("\t\t\t\tbalanceId : e.row.balanceId ,\r\n");
      ...
      out.write("\t\t//var data = {registerId : e} ;\r\n");
      ...
      out.write("        var marges = [\r\n");
      out.write("            { rowIndex: 0, columnIndex: 0, rowSpan: 1, colSpan: 10}\r\n");
      out.write("        ];\r\n");
      out.write("        grid.mergeCells(marges); */\r\n");
      out.write("        grid1.groupBy(\"orderBillId\", \"asc\");\r\n");
      out.write("\t\tgroup();\r\n");
      ...
      out.write(" \t\te.record.returnQty = e.record.nobackQty;\r\n");
      out.write(" \t\te.record.returnCost = (e.record.totCost / e.record.showQty * e.record.returnQty).toFixed(2);\r\n");
      out.write(" \t\t//e.record.checkFlag = \"1\";\r\n");
      out.write(" \t}\r\n");
      out.write(" \t\r\n");
      out.write(" \t// 行取消选中时发生\r\n");
      out.write(" \tfunction ondeselect(e) {\r\n");
      out.write(" \t\te.record.returnQty = null;\r\n");
      out.write(" \t\te.record.returnCost = null;\r\n");
      out.write(" \t\t//e.record.checkFlag = \"0\";\r\n");
      out.write(" \t}\r\n");
      out.write(" \t\r\n");
      out.write(" \t// 根据选中的处方项目计算总金额\r\n");
      out.write("\tfunction onselectionchanged() {\r\n");
      out.write("\t\tvar data = grid1.getList();\r\n");
      out.write("\t\tfor(var i = 0 ; i < data.length ; i++) {\r\n");
      out.write("\t\t\t// 修改选中标记值\r\n");
      out.write("\t\t\tvar checkState = grid1.isSelected( data[i] );\r\n");
      out.write("\t\t\tif (checkState == false) {\r\n");
      out.write("\t\t\t\tgrid1.updateRow(data[i],{checkFlag : \"0\"});\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\tgrid1.updateRow(data[i],{checkFlag : \"1\"});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t} \r\n");
      out.write(" \t\tvar rows = grid1.getSelecteds();\r\n");
      out.write(" \t\tvar cost = 0;// 退费金额\r\n");
      out.write(" \t\tfor(var i = 0 ; i < rows.length ; i++) {\r\n");
      out.write(" \t\t\t//grid1.updateRow(rows[i],{ returnQty : rows[i].nobackQty });\r\n");
      out.write(" \t\t\t//grid1.updateRow(rows[i],{ returnCost : (rows[i].totCost / rows[i].showQty * rows[i].returnQty).toFixed(2) });\r\n");
      out.write(" \t\t\tcost = cost + rows[i].totCost / rows[i].showQty * rows[i].returnQty ;\r\n");
      out.write("\t\t}\r\n");
      out.write(" \t\tdocument.getElementById(\"totCost\").innerHTML = cost.toFixed(2);\r\n");
      out.write(" \t\ttotCostNumber.setValue(cost.toFixed(2));\r\n");
      out.write("\t}\r\n");
      out.write(" \t\r\n");
      out.write(" \t// 单元格编辑前事件，确定退费量单元格是否可以编辑\r\n");
      out.write("\tfunction oncellbeginedit(e) {\r\n");
      out.write("\t\tvar checkState = grid1.isSelected( e.row );\r\n");
      out.write("\t\tif (checkState == false) {\r\n");
      out.write("\t\t\te.cancel = true;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif (checkState == true) {\r\n");
      out.write("\t\t\te.cancel = false;// 选中行的“退费量”单元格才允许编辑\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t/* if(e.field == \"returnQty\" && e.row.checkFlag != \"1\") {\r\n");
      out.write("\t\t\te.cancel = true;\r\n");
      out.write("\t\t} */\r\n");
      out.write("\t}\r\n");
      out.write(" \t\r\n");
      out.write(" \t// 行选中前事件，如果可退量小于等于0，则此行不可编辑\r\n");
      out.write(" \tfunction beforeselect(e) {\r\n");
      out.write(" \t\t//e.cancel = false;\r\n");
      out.write(" \t\tif(e.record.nobackQty <= 0) {\r\n");
      out.write("\t\t\te.cancel = true;\r\n");
      out.write("\t\t}\r\n");
      out.write(" \t}\r\n");
      out.write(" \t\r\n");
      out.write(" \t// 单元格编辑完成时事件\r\n");
      out.write(" \tfunction checkNum(e) {\r\n");
      out.write(" \t\t// 输入退费量后，确定输入的退费量是否正确\r\n");
      out.write(" \t\tif(e.field == \"returnQty\") {\r\n");
      out.write(" \t\t\tvar returnQty = mini.get(\"returnQty\").getValue();// 输入的值\r\n");
      out.write(" \t \t\tvar row = grid1.getRow(e.rowIndex);\r\n");
      out.write(" \t \t\tvar nobackQty;\r\n");
      out.write(" \t \t\tif( returnQty > 0 && returnQty < (row.showQty + 1) ){\r\n");
      out.write(" \t \t\t\tnobackQty = parseInt(returnQty);// 只允许输入介于1和可退量之间的值,且必须取整\r\n");
      out.write(" \t \t\t}\r\n");
      out.write(" \t \t\tif(returnQty < 1){\r\n");
      out.write(" \t \t\t\tnobackQty = null;\r\n");
      out.write(" \t \t\t\tgrid1.deselect(row , true);// 输入退费量小于1时，取消行选中状态\r\n");
      out.write(" \t \t\t}\r\n");
      out.write(" \t \t\tif(returnQty > row.nobackQty) {\r\n");
      out.write(" \t \t\t\tnobackQty = row.nobackQty;// 输入退费量大于可退量时，自动改为可退量\r\n");
      out.write(" \t \t\t}\r\n");
      out.write(" \t \t\tgrid1.updateRow(row,{returnQty : nobackQty});\r\n");
      out.write(" \t \t\t\r\n");
      out.write(" \t \t\tvar rows = grid1.getSelecteds();\r\n");
      out.write(" \t \t\tvar cost = 0;// 退费金额\r\n");
      out.write(" \t \t\tfor(var i = 0 ; i < rows.length ; i++) {\r\n");
      ...
      out.write(" \t\tvar rows = grid1.getSelecteds();\r\n");
      out.write(" \t\tif(rows.length == 0) {// 未选中任何退费项目\r\n");
      out.write(" \t\t\tmini.showTips({content:\"没有需要退费审核的数据\",state:\"warning\",x:\"center\",y:\"center\",timeout:3000});\r\n");
      out.write(" \t\t\treturn;\r\n");
      out.write(" \t\t}\r\n");
      out.write(" \t\tmini.confirm(\"退费流程进行后不可逆转，不能取消，请问是否确定继续退费？\",\"提示\",\r\n");
      ...
      out.write(" \t\r\n");
      out.write("\t// 退费(弹窗)\t\t\t\t\t\r\n");
      out.write(" \tfunction payInfoView(r) {\r\n");
      out.write("\t\tmini.open({\r\n");
      out.write("            url: \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/expense/outpatient/fee/outFeeCancel/payInfo.do?patientId=\" + r.patientId + \"&invoiceNo=\" + r.invoiceNo + \"&returnCost=\" + r.returnCost,\r\n");
      out.write("            title: \"退费\", \r\n");
      out.write("            width: 700, \r\n");
      ...
      out.write(" \t\r\n");
      out.write(" \t// 执行退费保存\r\n");
      out.write(" \tfunction cancelFee(e) {\r\n");
      out.write(" \t\tvar rows = grid1.getList();\r\n");
      out.write(" \t\tvar applys = mini.encode(rows);\r\n");
      out.write("\t\tvar registerId = mini.get(\"registerId\").getValue();\r\n");
      out.write("\t\tvar balanceId = mini.get(\"balanceId\").getValue();\r\n");
      out.write("\t\tvar data = {\r\n");
      out.write("\t\t\tapplys\t: applys,\r\n");
      out.write("\t\t\tregisterId : registerId,\r\n");
      out.write("\t\t\toldBalanceId : balanceId\r\n");
      out.write("\t\t};\r\n");
      out.write("\t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/expense/outpatient/opExpCharge/cancel.do\";\r\n");
      out.write("\t\t$.post(url, data , function(r) {\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar data2 = {\r\n");
      out.write("\t\t\t \t\t\treturnCost : r.returnCost,\r\n");
      out.write("\t\t\t \t\t\tinvoiceNo : r.invoiceNo,\r\n");
      out.write("\t\t\t \t\t\tpatientId : r.patientId\r\n");
      out.write("\t\t\t \t\t}\r\n");
      out.write("\t\t\t\tpayInfoView(data2);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif(!r.invoiceNo) {\r\n");
      out.write("\t\t\t\t\tr.invoiceNo = \"\";\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t// 部分退费时，打印新发票\r\n");
      ...
      out.write("\t\t<table style=\"font-size:14px;width:100%\" border=\"0\" cellspacing=\"0\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td class=\"form-label required\" style=\"width:90px;\">出生日期：</td>\r\n");
      ...
      out.write("\t\t<span style=\"font-size:20px;color:red;font-weight:bold;\">退费金额：</span>\r\n");
      out.write("\t\t<span id=\"totCost\" style=\"font-size:20px;color:red;font-weight:bold;\"></span>\r\n");
      out.write("\t\t<input id=\"totCostNumber\" class=\"mini-textbox\" visible=\"false\"/>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"mini-fit\">\r\n");
      out.write("\t\t<div id=\"grid1\" class=\"mini-datagrid\" style=\"width:1500px;height:100%;\" borderStyle=\"border:0\" onload=\"onLoad\" allowCellEdit=\"true\" allowCellSelect=\"true\" \r\n");
      out.write("\t\t\tshowPager=\"false\" multiSelect=\"true\" onlyCheckSelection=\"true\" idField=\"id\" allowResize=\"false\" onselectionchanged=\"onselectionchanged\" \r\n");
      out.write("\t\t\t\tonbeforeselect=\"beforeselect\" onselect=\"onselect\" ondeselect=\"ondeselect\" \r\n");
      out.write("\t\t\t\t\toncellbeginedit=\"oncellbeginedit\" oncellendedit=\"checkNum\" ondrawgroup=\"onDrawGroup\" url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("        \t\t<div field=\"orderGroupNo\" headerAlign=\"center\" align=\"center\" width=\"50\">组号</div> \r\n");
      ...
      out.write("        \t\t<div field=\"executeDeptId\" headerAlign=\"center\" align=\"center\" type=\"comboboxcolumn\" readOnly=\"true\">执行科室\r\n");
      ...
      out.write("        \t\t<div field=\"check\" type=\"checkcolumn\" width=\"40\"></div>\r\n");
      out.write("        \t\t<div field=\"checkFlag\" visible=\"false\">选择标记(隐藏)</div>\r\n");
      out.write("        \t\t<div field=\"returnQty\" headerAlign=\"center\" align=\"center\" width=\"60\">退费量\r\n");
      out.write("        \t\t\t<input id=\"returnQty\" property=\"editor\" class=\"mini-textbox\" style=\"width:100%;\"/>\r\n");
      out.write("        \t\t</div>\r\n");
      out.write("        \t\t<div field=\"returnCost\" headerAlign=\"center\" align=\"center\" width=\"80\">退费金额</div>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<!-- 选择发票弹出框 -->\r\n");
      out.write("\t<div id=\"win2\" title=\"请选择结算信息\" class=\"mini-window\" style=\"display:none;width:800px;height:300px;\">\r\n");
      ...
      out.write("\t\tvar totCostNumber = mini.get(\"totCostNumber\");\r\n");
      out.write("\t\tshow();\r\n");
      out.write("\t\t\r\n");
      out.write("\t</script>\r\n");
      out.write("</body>\r\n");
