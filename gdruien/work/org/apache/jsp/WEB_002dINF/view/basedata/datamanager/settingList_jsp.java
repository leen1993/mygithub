 ...
 * Generated at: 2018-05-15 07:47:40 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.view.basedata.datamanager;
...
public final class settingList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(row.settingId != null) {\r\n");
      out.write("\t\t\tmini.showTips({content:\"已保存数据不允许删除\",state:\"warning\",x:\"center\",y:\"center\",timeout:3000});\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t} else {\r\n");
      ...
      out.write("\t\t\tif(rows[i].settingName == null || rows[i].settingValue == null) {\r\n");
      out.write("\t\t\t\tmini.alert(\"控制参数信息不能缺少参数名称和参数值，请仔细检查！\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar gridDate = grid.getList();\r\n");
      out.write("\t\tfor(var i=0 ; i < rows.length ; i++) {\r\n");
      out.write("\t\t\tfor(var n=0 ; n < gridDate.length ; n++) {\r\n");
      out.write("\t\t\t\tif(grid.indexOf(rows[i]) == n) {// 避免与自己比较\r\n");
      out.write("\t\t\t\t\tcontinue;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(rows[i].settingName == gridDate[n].settingName) {\r\n");
      out.write("\t\t\t\t\tmini.alert(\"第\" + (grid.indexOf(rows[i]) + 1) + \"行与第\" + (n + 1) + \"行参数名称重复，请仔细检查！\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/basedata/datamanager/setting/save.do\";\r\n");
      out.write("\t\tvar fn = function(r) {\r\n");
      out.write("\t\t\tif (r == \"ok\") {\r\n");
      out.write("\t\t\t\tmini.showTips({content:\"保存数据成功\",state:\"success\",x:\"center\",y:\"center\",timeout:3000});\r\n");
      ...
      out.write("\t\t<a class=\"mini-button\" iconCls=\"fa fa-refresh\" onclick=\"javascript : grid.reload()\">刷新</a>\r\n");
      out.write("\t\t<a class=\"mini-button\" iconCls=\"fa fa-plus\" onclick=\"addRow\">添加</a>\r\n");
      out.write("\t\t<a class=\"mini-button\" iconCls=\"fa fa-trash-o\" onclick=\"removeRow\">删除</a>\r\n");
      out.write("\t\t<a class=\"mini-button\" iconCls=\"fa fa-save\" onclick=\"save\">保存</a>\r\n");
      out.write("\t\t<a href=\"export.do\" class=\"mini-button\" iconCls=\"fa fa-download\" onclick=\"\">导出</a>\r\n");
      out.write("\t\t<!-- <a class=\"mini-button\" iconCls=\"fa fa-window-close\" onclick=\"close\">退出</a> -->\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"mini-toolbar\" style=\"padding:1px;\">\r\n");
      out.write("\t\t<span style=\"margin-left:10px;font-size:10px;font-weight:bold;\">门诊相关</span>\r\n");
      out.write("\t</div>\r\n");
      out.write("    <div class=\"mini-fit\" >\r\n");
      out.write("    \t<div id=\"grid1\" class=\"mini-datagrid\" showPager=\"false\" pageSize=\"50\" contextMenu=\"#gridMenu\" style=\"width:100%;height:95%;\"\r\n");
      out.write("        \tborderStyle=\"border:1;\" onrowdblclick=\"\" allowCellEdit=\"true\" allowCellSelect=\"true\" multiSelect=\"false\" virtualScroll=\"true\" \r\n");
      out.write("        \t\turl=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/basedata/datamanager/setting/getAll.do\">\r\n");
      out.write("\t\t\t<div property=\"columns\">\r\n");
      out.write("\t\t\t\t<div type=\"indexcolumn\" width=\"20\"></div>\r\n");
      out.write("\t\t\t \t<div field=\"settingId\" headerAlign=\"center\" align=\"center\" width=\"60\">参数ID</div>\r\n");
      out.write("\t\t\t \t<div field=\"settingName\" headerAlign=\"center\" align=\"center\">参数名称\r\n");
      out.write("\t\t\t \t\t<input property=\"editor\" class=\"mini-textbox\" style=\"width:100%;\"/>\r\n");
      out.write("\t\t\t \t</div>\r\n");
      out.write("\t\t\t \t<div field=\"settingValue\" headerAlign=\"center\" align=\"center\" width=\"60\">参数值\r\n");
      out.write("\t\t\t \t\t<input property=\"editor\" class=\"mini-textbox\" style=\"width:100%;\"/>\r\n");
      out.write("\t\t\t \t</div>\r\n");
      out.write("\t\t\t \t<div field=\"description\" headerAlign=\"center\" align=\"center\" width=\"160\">参数描述\r\n");
      out.write("\t\t\t \t\t<input property=\"editor\" class=\"mini-textbox\" style=\"width:100%;\"/>\r\n");
      out.write("\t\t\t \t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
