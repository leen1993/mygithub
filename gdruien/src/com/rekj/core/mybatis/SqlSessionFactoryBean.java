		...
		try {
			...
			if (this.mapperLocations != null) {
				for (Resource mapperLocation : this.mapperLocations) {
					...
					try {
						XMLMapperBuilder xmlMapperBuilder = new XMLMapperBuilder(mapperLocation.getInputStream(), conf,
								path, conf.getSqlFragments());
			...
			new MapperRefresh(this.mapperLocations, conf).run();
