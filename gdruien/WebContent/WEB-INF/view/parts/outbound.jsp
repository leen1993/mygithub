...
<body>
    <h2>parts_outbound数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/parts/outbound/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id',">id</th>
                <th data-options="field:'outboundNum',">出库编号</th>
                <th data-options="field:'warehouseId',">仓库ID</th>
                <th data-options="field:'departmentId',">领用科室ID</th>
                <th data-options="field:'date',">出库日期</th>
                <th data-options="field:'outboundUid',">出库人ID</th>
                <th data-options="field:'recipientUid',">领用人ID</th>
                <th data-options="field:'repairId',">维修单ID</th>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>出库编号</td>
                     <td><input class="easyui-textbox" type="text" name="outboundNum" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>仓库ID</td>
                ...
                <tr>
                     <td>出库人ID</td>
                     <td><input class="easyui-textbox" type="text" name="outboundUid" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>领用人ID</td>
                     <td><input class="easyui-textbox" type="text" name="recipientUid" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>维修单ID</td>
                     <td><input class="easyui-textbox" type="text" name="repairId" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>备注</td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/parts/outbound/update.do",
              data: $('#ff').serialize(),
