...
<body>
    <h2>asset_cate数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/asset/cate/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id',">id</th>
                <th data-options="field:'fid',">上级分类ID</th>
                <th data-options="field:'name',">资产分类名</th>
                <th data-options="field:'code',">资产分类编码</th>
                <th data-options="field:'sort',">排序，越大越靠前，默认0</th>
            </tr>
        </thead>
    </table>
