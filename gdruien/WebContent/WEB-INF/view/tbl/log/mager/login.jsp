...
<head>
<title>tbl_log_mager_login</title>
...
<body>
    <h2>tbl_log_mager_login数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/tbl/log/mager/login/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'logId',">日志流水号,自动递增</th>
                <th data-options="field:'userId',">用户ID，对应用户表主键</th>
                <th data-options="field:'logTime',">登录时间</th>
                <th data-options="field:'logIp',">登陆的IP地址</th>
                <th data-options="field:'logRefer',">登录浏览器记录</th>
                <th data-options="field:'logResult',">登录状态. 1. 成功，2.失败</th>
                <th data-options="field:'logInfo',">登录明细。json格式存储详细数据</th>
            </tr>
        </thead>
    </table>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/tbl/log/mager/login/update.do",
              data: $('#ff').serialize(),
