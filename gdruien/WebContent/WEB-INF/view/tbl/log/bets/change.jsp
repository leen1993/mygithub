...
<head>
<title>tbl_log_bets_change</title>
...
<body>
    <h2>tbl_log_bets_change数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/tbl/log/bets/change/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'logId',">日志流水</th>
                <th data-options="field:'cgType',">变动类型. 1.投注，2.奖期清算，3.撤单</th>
                <th data-options="field:'cgTime',">变动时间</th>
                <th data-options="field:'ordId',">引起变动的订单ID</th>
                <th data-options="field:'cgInfo',">变动明细备注</th>
            </tr>
        </thead>
    </table>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/tbl/log/bets/change/update.do",
              data: $('#ff').serialize(),
