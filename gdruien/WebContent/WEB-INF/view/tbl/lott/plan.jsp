...
<body>
    <h2>tbl_lott_plan数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/tbl/lott/plan/getAll.do',method:'get'">
        <thead>
            <tr>
                ...
                <th data-options="field:'issId',">开始期号ID</th>
                <th data-options="field:'issName',">开始期号名称</th>
                <th data-options="field:'planNum',">追号期数</th>
                ...
                <th data-options="field:'proStatus',">方案状态。1：未开奖，2：已中奖，3：未中奖</th>
                <th data-options="field:'proStop',">中奖后是否停止。0：否，1：是</th>
                <th data-options="field:'planDetail',">计划明细</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>追号期数</td>
                     <td><input class="easyui-textbox" type="text" name="planNum" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>投注内容</td>
                ...
                <tr>
                     <td>中奖后是否停止。0：否，1：是</td>
                     <td><input class="easyui-textbox" type="text" name="proStop" data-options="required:true"></td>
                </tr>
                <tr>
                     <td>计划明细</td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/tbl/lott/plan/update.do",
              data: $('#ff').serialize(),
