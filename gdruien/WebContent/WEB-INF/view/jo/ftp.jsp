...
<body>
    ...
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jo/ftp/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'ftpId',">ftpId</th>
                <th data-options="field:'ftpName',">..</th>
                <th data-options="field:'ip',">IP</th>
                <th data-options="field:'port',">...</th>
                <th data-options="field:'username',">...</th>
                <th data-options="field:'password',">....</th>
                <th data-options="field:'encoding',">..</th>
                <th data-options="field:'timeout',">....</th>
                <th data-options="field:'ftpPath',">..</th>
