...
<body>
    ...
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/process/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id',">id</th>
                <th data-options="field:'cateId',">分类ID</th>
                <th data-options="field:'name',">流程名</th>
                <th data-options="field:'sort',">排序，越大越靠前，默认0</th>
                <th data-options="field:'status',">1启用，0禁用</th>
            </tr>
        </thead>
    </table>
