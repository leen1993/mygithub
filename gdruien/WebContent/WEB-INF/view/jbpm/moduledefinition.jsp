...
<head>
<title>jbpm_moduledefinition</title>
...
<body>
    <h2>jbpm_moduledefinition数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jbpm/moduledefinition/getAll.do',method:'get'">
        <thead>
            <tr>
                ...
                <th data-options="field:'starttask_',">starttask_</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="starttask_" data-options="required:false"></td>
                </tr>
                <tr>
                    <td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jbpm/moduledefinition/update.do",
              data: $('#ff').serialize(),
