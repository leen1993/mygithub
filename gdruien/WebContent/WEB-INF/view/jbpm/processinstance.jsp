...
<head>
<title>jbpm_processinstance</title>
...
<body>
    <h2>jbpm_processinstance数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jbpm/processinstance/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id_',">id_</th>
                <th data-options="field:'version_',">version_</th>
                <th data-options="field:'key_',">key_</th>
                ...
                <th data-options="field:'roottoken_',">roottoken_</th>
                <th data-options="field:'superprocesstoken_',">superprocesstoken_</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="key_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="roottoken_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="superprocesstoken_" data-options="required:false"></td>
                </tr>
                <tr>
                    <td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jbpm/processinstance/update.do",
              data: $('#ff').serialize(),
