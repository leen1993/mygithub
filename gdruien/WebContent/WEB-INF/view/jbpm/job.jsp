...
<body>
    <h2>jbpm_job数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jbpm/job/getAll.do',method:'get'">
        <thead>
            <tr>
                ...
                <th data-options="field:'isexclusive_',">isexclusive_</th>
                <th data-options="field:'lockowner_',">lockowner_</th>
                <th data-options="field:'locktime_',">locktime_</th>
                <th data-options="field:'exception_',">exception_</th>
                <th data-options="field:'retries_',">retries_</th>
                ...
                <th data-options="field:'graphelementtype_',">graphelementtype_</th>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="isexclusive_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="lockowner_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="locktime_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="retries_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="graphelementtype_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
