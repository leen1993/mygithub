...
<head>
<title>jbpm_processdefinition</title>
...
<body>
    <h2>jbpm_processdefinition数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jbpm/processdefinition/getAll.do',method:'get'">
        <thead>
            <tr>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="version_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jbpm/processdefinition/update.do",
              data: $('#ff').serialize(),
