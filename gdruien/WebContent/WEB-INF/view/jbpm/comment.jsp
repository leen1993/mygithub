...
<body>
    <h2>jbpm_comment数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jbpm/comment/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id_',">id_</th>
                <th data-options="field:'version_',">version_</th>
                <th data-options="field:'actorid_',">actorid_</th>
                <th data-options="field:'time_',">time_</th>
                ...
                <th data-options="field:'tokenindex_',">tokenindex_</th>
                <th data-options="field:'taskinstanceindex_',">taskinstanceindex_</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="time_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                ...
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="tokenindex_" data-options="required:false"></td>
                </tr>
                <tr>
                     <td></td>
                     <td><input class="easyui-textbox" type="text" name="taskinstanceindex_" data-options="required:false"></td>
                </tr>
                <tr>
                    <td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jbpm/comment/update.do",
              data: $('#ff').serialize(),
