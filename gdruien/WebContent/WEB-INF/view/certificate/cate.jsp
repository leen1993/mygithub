...
<body>
    <h2>certificate_cate数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/certificate/cate/getAll.do',method:'get'">
        <thead>
            <tr>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/certificate/cate/update.do",
              data: $('#ff').serialize(),
