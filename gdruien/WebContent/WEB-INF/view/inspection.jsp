...
<body>
    <h2>inspection数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/inspection/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id',">id</th>
                <th data-options="field:'equipmentId',">设备id</th>
                <th data-options="field:'remark',">备注</th>
                <th data-options="field:'time',">巡检时间</th>
                <th data-options="field:'status',">设备状态 1正常 2不正常</th>
            </tr>
        </thead>
    </table>
