...
<head>
<title>jc_receiver_message</title>
...
<body>
    <h2>jc_receiver_message数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jc/receiver/message/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'msgReId',">消息id</th>
                <th data-options="field:'msgTitle',">标题</th>
                <th data-options="field:'msgContent',">内容</th>
                <th data-options="field:'sendTime',">发送时间</th>
                <th data-options="field:'msgSendUser',">发信息人</th>
                <th data-options="field:'msgReceiverUser',">接收人</th>
                <th data-options="field:'msgStatus',">消息状态0未读，1已读</th>
                <th data-options="field:'msgBox',">消息信箱 0收件箱 1发件箱 2草稿箱 3垃圾箱</th>
                <th data-options="field:'msgId',">发信的信件id</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>消息id</td>
                     <td><input class="easyui-textbox" type="text" name="msgReId" data-options="required:true"></td>
                </tr>
                <tr>
                     <td>标题</td>
                ...
                <tr>
                     <td>发信的信件id</td>
                     <td><input class="easyui-textbox" type="text" name="msgId" data-options="required:false"></td>
                </tr>
                <tr>
                    <td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jc/receiver/message/update.do",
              data: $('#ff').serialize(),
