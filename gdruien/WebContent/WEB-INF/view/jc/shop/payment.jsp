...
<body>
    <h2>jc_shop_payment数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jc/shop/payment/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'paymentId',">paymentId</th>
                <th data-options="field:'websiteId',">站点ID</th>
                <th data-options="field:'name',">支付名称</th>
                <th data-options="field:'description',">描述</th>
                <th data-options="field:'priority',">排列顺序</th>
                <th data-options="field:'isDisabled',">是否禁用</th>
                <th data-options="field:'isDefault',">是否是默认</th>
                <th data-options="field:'type',">支付类型</th>
                <th data-options="field:'introduce',">介绍</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>介绍</td>
                     <td><input class="easyui-textbox" type="text" name="introduce" data-options="required:false"></td>
                </tr>
                <tr>
                    <td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jc/shop/payment/update.do",
              data: $('#ff').serialize(),
