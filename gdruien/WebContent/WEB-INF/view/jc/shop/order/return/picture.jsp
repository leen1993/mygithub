...
<head>
<title>jc_shop_order_return_picture</title>
...
<body>
    <h2>jc_shop_order_return_picture数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jc/shop/order/return/picture/getAll.do',method:'get'">
        <thead>
            <tr>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>图片地址</td>
                     <td><input class="easyui-textbox" type="text" name="imgPath" data-options="required:true"></td>
                </tr>
                <tr>
                     <td>描述</td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jc/shop/order/return/picture/update.do",
              data: $('#ff').serialize(),
