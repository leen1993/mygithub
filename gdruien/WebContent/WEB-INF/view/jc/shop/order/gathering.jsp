...
<head>
<title>jc_shop_order_gathering</title>
...
<body>
    <h2>jc_shop_order_gathering数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jc/shop/order/gathering/getAll.do',method:'get'">
        <thead>
            <tr>
                ...
                <th data-options="field:'accounts',">帐号</th>
                <th data-options="field:'money',">金额</th>
                <th data-options="field:'drawee',">付款人</th>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>银行</td>
                     <td><input class="easyui-textbox" type="text" name="bank" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>帐号</td>
                     <td><input class="easyui-textbox" type="text" name="accounts" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>金额</td>
                ...
                <tr>
                     <td>付款人</td>
                     <td><input class="easyui-textbox" type="text" name="drawee" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>备注</td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jc/shop/order/gathering/update.do",
              data: $('#ff').serialize(),
