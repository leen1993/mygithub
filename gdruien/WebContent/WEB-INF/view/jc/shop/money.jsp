...
<body>
    <h2>jc_shop_money数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jc/shop/money/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id',">id</th>
                <th data-options="field:'memberId',">会员Id</th>
                <th data-options="field:'name',">来源/用途</th>
                <th data-options="field:'money',">金额</th>
                <th data-options="field:'status',">0是支出，1,是收入</th>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jc/shop/money/update.do",
              data: $('#ff').serialize(),
