...
<body>
    <h2>jc_core_admin数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jc/core/admin/getAll.do',method:'get'">
        <thead>
            <tr>
                ...
                <th data-options="field:'isViewonlyAdmin',">是否只读用户</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>是否只读用户</td>
                     <td><input class="easyui-textbox" type="text" name="isViewonlyAdmin" data-options="required:true"></td>
                </tr>
                <tr>
                    <td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jc/core/admin/update.do",
              data: $('#ff').serialize(),
