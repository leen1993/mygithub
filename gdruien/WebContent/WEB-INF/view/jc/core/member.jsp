...
<body>
    <h2>jc_core_member数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/jc/core/member/getAll.do',method:'get'">
        <thead>
            <tr>
                ...
                <th data-options="field:'isActive',">是否激活</th>
                <th data-options="field:'activationCode',">激活码</th>
            </tr>
        </thead>
    </table>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>是否激活</td>
                     <td><input class="easyui-textbox" type="text" name="isActive" data-options="required:true"></td>
                </tr>
                <tr>
                     <td>激活码</td>
                     <td><input class="easyui-textbox" type="text" name="activationCode" data-options="required:false"></td>
                </tr>
                <tr>
                    <td>
 ...
 <script>
     ...
     function submitForm() { 
          ...
          $.ajax({
              type: "POST",
              url: "${ctx }/jc/core/member/update.do",
              data: $('#ff').serialize(),
