...
<body>
    <h2>auth_group数据增上改查</h2>
    <p></p>
    <div style="margin:20px 0;"></div>
    <table id="dg_id" class="easyui-datagrid" title="Basic DataGrid" style="width:800px;height:500px"
            data-options="toolbar:'#tb',singleSelect:true,collapsible:true,url:'${ctx }/auth/group/getAll.do',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'id',">id</th>
                <th data-options="field:'title',">角色名</th>
                <th data-options="field:'status',">1正常，0删除</th>
                <th data-options="field:'rules',">权限规则ID</th>
    ...
    <div id="w" class="easyui-window" title="更新" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:350px;padding:10px;">
          <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                     <td>权限规则ID</td>
                     <td><input class="easyui-textbox" type="text" name="rules" data-options="required:false"></td>
                </tr>
                <tr>
                     <td>备注</td>
